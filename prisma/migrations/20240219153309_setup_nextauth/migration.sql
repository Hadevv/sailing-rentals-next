...
-- AlterTable
ALTER TABLE "Boat" ALTER COLUMN "ownerId" SET DATA TYPE TEXT;

-- AlterTable
ALTER TABLE "Booking" ALTER COLUMN "renterId" SET DATA TYPE TEXT;
...
-- AlterTable
ALTER TABLE "Rental" ALTER COLUMN "renterId" SET DATA TYPE TEXT;
